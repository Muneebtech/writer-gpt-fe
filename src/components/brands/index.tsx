import React, { ChangeEvent, FormEvent, useEffect, useMemo, useRef } from "react";
...
const Brands = () => {
  ...
  const filteredData = useMemo(() => {
    ...
    if (selectedCategory) {
      filtered = filtered.filter((data) =>
        data.catergory.toLowerCase() === selectedCategory.toLowerCase()
      );
    }
    return filtered;
    ...
    <>
      <> <div className="pt-4 flex flex-col text-black gap-5 fade-in">
        <div className="flex items-center justify-between">
          <Header title="CHANNELS" showSearch={true} searchKeyword="Search" onSearch={handleSearch} />
          <Button onClick={handleOpenModal} variant="contained" className="button-black ps-4 pe-4">
              ...
              <div className="flex items-center pb-6 pt-6 ">
                <div className="Side-spacing ">
                  ...
                  <div >
                    ...
                    <Popover onClose={handlePopoverClose} open={popoverOpen}>
